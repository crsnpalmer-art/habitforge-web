...
1. **Default renewal**: You must actively cancel, which most people delay.
2. **Low emotional salience**: The charge feels minor in isolation.
3. **Category blending**: Expenses spread across cards or apps are hard to aggregate.
...
**Step 1: Run a 60-day recall window.**
Open statements and list only subscriptions that were used less than 20% of days in the last 60 days.

**Step 2: Classify by value type.**
- Functional (
 utilities, essential software, transportation )
...
**Step 3: Impose a 90-day challenge.**
Pause, pause, pause. Cancel 3–5 low-value items for 90 days instead of permanently removing everything.

A complete shutdown often triggers loss aversion fear. A trial-like pause avoids that resistance.

**Step 4: Set renewal checkpoints quarterly.**
Put a recurring calendar block every three months: review services, check usage, remove what no longer matches goals.
