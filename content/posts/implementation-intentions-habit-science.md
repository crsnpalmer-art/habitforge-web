---
title: "Implementation Intentions: The If-Then Formula That Makes Habits Actually Stick"
date: "2026-03-20"
...
**1. Be hyper-specific**
Vague: "I'll meditate in the morning."
Strong: "When my alarm goes off at 6:30 AM, I will sit in the chair by my window and open the Waking Up app for 10 minutes."

**2. Use natural environmental cues**
The best cues are things that already happen reliably — waking up, finishing lunch, sitting down at your desk. Don't create new triggers; piggyback on existing ones.

**3. Address anticipated obstacles with "coping intentions"**
A variant called a *coping implementation intention* handles the "but what if" problem:
...
**4. One behavior per intention**
Don't stack five behaviors into one if-then plan. Write separate intentions for separate behaviors. Specificity is the whole point.
...
## Integrating With Your Habit System
