...
## Why It Matters More Than VO2 Max for Many Athletes
...
- **LT2 estimation:** Your best sustainable 45–60 minute all-out effort (critical power / functional threshold power in cycling, or threshold pace in running) is a reasonable proxy for LT2
- **Talk test:** LT1 roughly corresponds to the intensity at which speech becomes labored but still possible; LT2 to the point where only a few words can be spoken per breath
- **Heart rate-based:** While imprecise, the intensity at which heart rate begins to "decouple" from pace (rising faster than expected) roughly tracks LT

## Training to Raise Lactate Threshold
