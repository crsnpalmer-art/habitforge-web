...
## What decision fatigue is really doing
...
## Why this destroys habits specifically
...
## The practical fix: reduce decisions before they become the default

### 1) Pre-commit your defaults

Design one default path for each recurring situation.

- Same workout clothes, same floor mat location, same app playlist, same time block every weekday.
- Same morning finance stack: open savings app? auto-transfer already done? if not, handle it immediately and no extra choice.

The fewer branches your future self has to evaluate, the more likely the system executes itself.

### 2) Limit optional choices, don’t remove all choices
...
### 3) Put hard decisions in the morning
