...
export const metadata: Metadata = {
  title: "Annual Goal Planner — HabitForge",
  description: "Break your annual goal into quarterly milestones and weekly actions. Free interactive goal planning tool.",
};
